...
const TutorDashboard = () => {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,0.18),transparent_30%),linear-gradient(135deg,#03111f,#020617)] text-white px-6 py-7">
      <h1 className="text-3xl font-bold mb-7">Welcome Back, Tutor 👋</h1>

      <div className="grid gap-6 xl:grid-cols-[0.95fr_1fr]">
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <StatCard title="Total Courses" value="5" icon={<TrendingUp />} />
            <StatCard title="Students" value="120" icon={<TrendingUp />} />
            <StatCard title="Assignments" value="12" icon={<TrendingUp />} />
            <StatCard title="Trend" value="↝" icon={<TrendingUp />} />
          </div>
